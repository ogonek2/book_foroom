<template>
    <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300 h-full
        ...
        <div>
            ...
            <div v-if="!isEditing">
                <!-- Blocked Content -->
                <div v-if="fact.status === 'blocked'" class="my-3">
                    <div class="border-2 border-red-300 dark:border-red-700 rounded-lg bg-red-50/50 dark:bg-red-900/20 p-4">
                        <div class="relative overflow-hidden rounded-md mb-3">
                            <p class="text-lg text-slate-700 dark:text-slate-300 leading-relaxed font-medium break-words blur-sm filter"
                        ...
                        <div class="flex items-start gap-3 pt-2 border-t border-red-200 dark:border-red-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p v-if="fact.moderation_reason" class="text-xs text-red-600 dark:text-red-400 mt-1">
                                    Причина: {{ fact.moderation_reason }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Normal Content -->
                <div v-else class="text-lg text-slate-700 dark:text-slate-300 leading-relaxed font-medium my-4 break-words"
                    style="word-break: break-word; overflow-wrap: break-word; hyphens: auto; -webkit-hyphens: auto; -ms-hyphens: auto;">
                    {{ fact.content }}
                </div>
            </div>
