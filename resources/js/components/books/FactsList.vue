<template>
    <div class="lg:bg-white/80 lg:dark:bg-slate-800/80 lg:backdrop-blur-xl rounded-3xl lg:shadow-xl lg:border border-white/20 dark:border-slate-700/30 lg:p-8">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center justify-between mb-6">
            ...
            <div v-if="!hideHeader">
                <button v-if="isAuthenticated" @click="showAddForm = !showAddForm"
        ...
        <div v-if="showAddForm"
            ...
            <form @submit.prevent="addFact">
                <div class="mb-4">
                    <textarea v-model="newFact" placeholder="Введіть цікавий факт про книгу..."
...
export default {
    ...
    methods: {
        ...
        showNotification(message, type) {
            ...
            notification.className = `fixed top-4 right-4 z-50 px-6 py-3 rounded-lg text-white font-semibold shadow-lg transform transition-all duration-300 ${type === 'success' ? 'bg-green-500' : type === 'error' ? 'bg-red-500' : 'bg-blue-500'
                }`;
