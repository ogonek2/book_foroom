            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <button @click="selectStatus('read')"
                            :class="[
                                'w-full text-left p-4 rounded-xl border-2 transition-all duration-300 group',
                                currentStatus === 'read' 
                                    ? 'border-indigo-500 dark:border-indigo-400 bg-indigo-50 dark:bg-indigo-900/30' 
                                    : 'border-transparent hover:border-indigo-500 dark:hover:border-indigo-400 bg-slate-50 dark:bg-slate-700 hover:bg-indigo-50 dark:hover:bg-indigo-900/20'
                            ]">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                                        Прочитано</h4>
                                    <span v-if="currentStatus === 'read'" class="text-indigo-600 dark:text-indigo-400 text-sm font-medium">
                                        Обрано
                                    </span>
                                </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                                        Читаю</h4>
                                    <span v-if="currentStatus === 'reading'" class="text-indigo-600 dark:text-indigo-400 text-sm font-medium">
                                        Обрано
                                    </span>
                                </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                                        Буду читати</h4>
                                    <span v-if="currentStatus === 'want_to_read'" class="text-indigo-600 dark:text-indigo-400 text-sm font-medium">
                                        Обрано
                                    </span>
                                </div>
                    ...
                    <button @click="selectStatus('abandoned')"
                            :class="[
                                ...
                                currentStatus === 'abandoned' 
                                    ...
                                    : 'border-transparent hover:border-red-500 dark:hover:border-red-400 bg-slate-50 dark:bg-slate-700 hover:bg-red-50 dark:hover:bg-red-900/20'
                            ]">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
                                        Закинуто</h4>
                                    <span v-if="currentStatus === 'abandoned'" class="text-red-600 dark:text-red-400 text-sm font-medium">
                                        Обрано
                                    </span>
                                </div>
