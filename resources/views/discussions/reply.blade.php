...
@section('title', $discussion->title . ' - Відповідь')
        ...
        @push('scripts')
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    // Highlight the target reply
                    const targetReply = document.querySelector('[data-reply-id="{{ $highlightedReplyId }}"]');
                    if (targetReply) {
                        targetReply.classList.add('highlighted-reply');
                        
                        // Smooth scroll to the reply
                        setTimeout(() => {
                        ...
                        setTimeout(() => {
                            targetReply.classList.remove('highlighted-reply');
                        }, 5000);
                    }
                });
