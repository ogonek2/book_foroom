    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const initialIsDraft = @json((bool) old('is_draft', $discussion->is_draft));
                ...
                const syncActionUI = () => {
                    ...
                    if (submitBtn) {
                        ...
                        if (actionMode === 'draft') {
                            ...
                            if (span) span.textContent = 'Оновити обговорення';
                        }
                    }
                };
                ...
                // Ensure initial mode/UI is consistent with current draft state
                syncActionUI();
