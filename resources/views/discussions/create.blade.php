...
@section('title', 'Створити обговорення - Книжковий форум')
    ...
    <div class="w-full space-y-8">
        ...
        <nav class="text-sm text-slate-500 dark:text-slate-400">
            <ol class="flex flex-wrap gap-2">
                ...
                <li>/</li>
                <li class="font-semibold text-slate-900 dark:text-white">Створити обговорення</li>
            </ol>
        </nav>
        ...
        <div class="w-full">
            ...
            <div>
                ...
                <div>
                    <form id="discussion-form" action="{{ route('discussions.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div id="discussion-editor-app">
                                <discussion-editor v-model="editorContent"
                                    :placeholder="'Опишіть тему для обговорення. Використовуйте @ для згадки користувачів та # для хештегів...'"
                                    @input="updateContent" @change="updateContent"></discussion-editor>
                            </div>

                            <!-- Single hidden textarea for form submission -->
                            <textarea id="content" name="content"
                                style="display: none !important; visibility: hidden !important; position: absolute !important; left: -9999px !important; width: 0 !important; height: 0 !important; opacity: 0 !important; pointer-events: none !important;">{{ old('content') }}</textarea>
                        ...
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_closed" id="is_closed" value="1" {{ old('is_closed') ? 'checked' : '' }} class="sr-only peer">
                                ...
                                <span class="ml-3 text-sm font-medium text-slate-900 dark:text-white" id="is_closed_label">
                                    {{ old('is_closed') ? 'Закрите' : 'Відкрите' }}
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="pt-4 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <button type="submit" id="submit-btn"
                                ...
                                <span>Створити обговорення</span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const editorApp = new Vue({
                    ...
                    data: {
                        editorContent: contentInput ? contentInput.value : '',
                    },
                    methods: {
                        updateContent(html) {
