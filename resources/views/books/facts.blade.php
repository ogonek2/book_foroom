...
@section('title', $book->title . ' — Цікаві факти')
        ...
        <div class="w-full flex items-start">
            ...
            <div class="w-full flex-1 space-y-2">
                        ...
                        <div class="flex gap-4 items-center">
                            ...
                            <div>
                                ...
                                <div class="flex gap-6 mt-4">
                                    ...
                                    <div>
                                        <p class="text-xs text-slate-500 dark:text-сlate-400 uppercase">Фактів</p>
                                        <p class="text-2xl font-bold text-slate-900 dark:text-white">{{ $factsCount }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="pt-4 lg:pt-0 p-0">
                    <facts-page-list :facts='@json($factsData)' book-slug="{{ $book->slug }}"
