                                        ...
                                        <div class="flex w-full flex-col h-auto justify-between">
                                            <div>
                                                ...
                                                <div class="flex items-center mb-2">
                                                    ...
                                                    <span
                                                        class="ml-2 text-sm text-gray-600 dark:text-gray-400 font-medium">{{ $book->rating }}</span>
                                                    <span
                                                        class="ml-1 text-sm text-gray-500 dark:text-gray-500">({{ $book->reviews_count }})</span>
                                                </div>
                                            </div>
