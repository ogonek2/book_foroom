        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center justify-between text-xs font-semibold text-gray-500 dark:text-gray-400">
                                        ...
                                        <span>До: @{{ filters.rating_max }}</span>
                                    </div>
                                    <div class="flex flex-col space-y-3">
                                        <input type="range" min="1" max="10" v-model.number="filters.rating_min"
                                            @change="normalizeRatingRange('min')"
                                            class="w-full accent-purple-600">
                                        <input type="range" min="1" max="10" v-model.number="filters.rating_max"
                                            @change="normalizeRatingRange('max')"
                                            class="w-full accent-purple-600">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="lg:col-span-3">
                <transition name="fade" mode="out-in">
                    ...
                    <div v-else key="empty" class="text-center py-12 bg-white/60 dark:bg-gray-800/60 rounded-2xl border border-gray-200/30 dark:border-gray-700/30">
                    ...
                    const booksBrowser = new Vue({
                        ...
                        data: {
                            ...
                            filters: {
                                ...
                                rating_max: Number(@json(request('rating_max', 10))),
                            },
                            loading: false,
                            error: null,
                            debounceTimer: null,
                        ...
                        watch: {
                            ...
                            'filters.rating_max'(value) {
                                this.filters.rating_max = Math.max(1, Math.min(10, Number(value)));
                                this.fetchBooksDebounced();
                            }
                        },
                        methods: {
                            fetchBooks(page = 1) {
                                ...
                                const params = {
                                    ...
                                    rating_max: this.filters.rating_max,
                                    page,
                                };
                            ...
                            normalizeRatingRange(changed) {
                                if (this.filters.rating_min > this.filters.rating_max) {
                                    if (changed === 'min') {
                                        this.filters.rating_max = this.filters.rating_min;
                                    } else {
                                        this.filters.rating_min = this.filters.rating_max;
                                    }
                                }
                                this.fetchBooks();
                            },
