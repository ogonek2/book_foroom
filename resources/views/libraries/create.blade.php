                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <ul class="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                                    <li>• Використовуйте зрозумілу та привабливу назву, яка відображає ідею добірки</li>
                                    <li>• Додайте опис, щоб інші користувачі краще зрозуміли її тематику</li>
                                    <li>• Публічні добірки можуть отримувати вподобання від інших користувачів</li>
                                    <li>• Після створення добірки ви зможете додати до неї книги з каталогу</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <ul class="text-orange-800 dark:text-orange-200 space-y-1">
                            ...
                            <li>• Редагувати назву та опис у будь-який час</li>
                            <li>• Змінювати видимість добірки (публічна / приватна)</li>
                            <li>• Видаляти книги з добірки</li>
                            <li>• Ділитися добіркою з друзями</li>
                        </ul>
                    </div>
                </div>
            </div>
