...
@section('title', $author->full_name . ' — Рецензії на книги автора')

@section('main')
    <div id="author-reviews-app" class="max-w-7xl mx-auto space-y-8">
        <nav class="text-sm text-slate-500 dark:text-slate-400">
            <ol class="flex flex-wrap gap-2">
                ...
                <li>/</li>
                <li class="font-semibold text-slate-900 dark:text-white">Рецензії</li>
            </ol>
        </nav>
        ...
        <div class="w-full flex items-start">
            ...
            <div class="w-full flex-1 space-y-2">
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 dark:text-slate-300 mt-2">
                                Всього рецензій: <span class="font-semibold">{{ $reviewsCount }}</span>
                            </p>
                        </div>
                ...
                <div class="pt-4 lg:pt-0 p-0">
                    <book-reviews-list :reviews='@json($reviewsData)'
                        book-slug=""
                        :current-user-id="{{ auth()->check() ? auth()->id() : 'null' }}"
                        :user-review='null' :hide-header="true" :hide-add-button="true"
