    ...
    <div class="flex flex-col">
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-slate-600 dark:text-slate-400">
                Заповніть форму, щоб стати частиною нашої спільноти
            </p>
        </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400">
                                    Діліться своїми думками про прочитані книги, отримуйте рекомендації та відкривайте нові цікаві твори
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400">
                                    Діліться своїми оцінками та детальними рецензіями, допомагаючи іншим відкривати найкращі книги
                                </p>
                            </div>
                </div>
                </div>
