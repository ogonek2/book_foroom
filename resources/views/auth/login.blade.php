                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400">
                                    Поверніться до вашої бібліотеки та продовжуйте відстежувати прогрес читання ваших
                                    улюблених книг
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400">
                                    Всі ваші оцінки, рецензії та закладки зберігаються і доступні в будь-який момент
                                </p>
                            </div>
                        </div>
