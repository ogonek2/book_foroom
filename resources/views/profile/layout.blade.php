                ...
                <div class="flex gap-6">
                    ...
                    <div style="width: 200px;">
                        ...
                        <div class="relative mb-4">
                            ...
                            @else
                                <div class="w-full rounded-lg bg-gradient-to-br from-orange-500 to-pink-600 flex items-center justify-center border-4 border-white shadow-2xl"
                                    style="aspect-ratio: 1/1;">
                        ...
                        <div class="flex justify-around mb-4 text-gray-300 text-sm space-x-4">
                            <div class="text-center">
                                <div class="font-bold">{{ Auth::user()->discussions->count() }}</div>
                                <div class="text-xs">Пости</div>
                            </div>
                            <div class="text-center">
                                <div class="font-bold">{{ Auth::user()->reviews->count() }}</div>
                        ...
                        <div class="text-white mb-6">
                                                ...
                                                <form method="POST" action="{{ route('logout') }}">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-xs text-gray-400">Вийти з облікового запису
                                                            </div>
                                                        </div>
                                                    </button>
                                                </form>
                            ...
                            @if (request()->routeIs('profile.show') || request()->routeIs('profile.user.show'))
                                ...
                                <div class="flex space-x-2 mb-4">
                                    @for ($i = 0; $i < 6; $i++)
                                        <div
                                            class="w-10 h-10 rounded-full border-2 border-{{ ['green', 'gray', 'yellow', 'blue', 'purple', 'pink'][$i] }}-500 flex items-center justify-center bg-gray-800">
                                            <svg class="w-5 h-5 text-{{ ['green', 'gray', 'yellow', 'blue', 'purple', 'pink'][$i] }}-400"
                    ...
                    <div style="width: 320px;" class="z-10">
                        <div class="bg-gray-800 rounded-lg p-6 shadow-2xl">
                            ...
                            <div class="flex items-center justify-between mb-6">
                                <span
                                    class="bg-orange-500 text-white px-3 py-1 rounded-full text-sm font-medium">Бібліоман</span>
                                ...
                                @if ($currentlyReading->count() > 0)
                                    <div class="space-y-2">
                                        ...
                                        @if ($readingStats['reading_count'] > 3)
                                            <span class="text-cyan-400 text-sm">та ще
                                                {{ $readingStats['reading_count'] - 3 }} книг</span>
                                        @endif
                                    </div>
                                @else
                                ...
                                @if ($readingStats['average_rating'])
                                    <div class="flex items-center mb-4">
                                        <div class="flex space-x-1">
                                            @for ($i = 1; $i <= 5; $i++)
                                                <svg class="w-5 h-5 {{ $i <= $readingStats['average_rating'] / 2 ? 'text-yellow-400' : 'text-gray-600' }}"
                                                    fill="currentColor" viewBox="0 0 20 20">
                                                    <path
                                                        d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                                    </path>
                                        ...
                                        <span
                                            class="ml-2 text-white font-bold">{{ number_format($readingStats['average_rating'], 1) }}/10</span>
                                    </div>
