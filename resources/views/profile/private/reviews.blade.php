            ...
            <div class="grid grid-cols-3 gap-2 lg:gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 text-center">
                    <div class="text-2xl font-bold text-green-400 mb-1">
                        {{ $averageLength ? number_format($averageLength) : 0 }}</div>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    @if($review->rating)
                                        <div class="flex items-center space-x-2 mb-3">
                                            ...
                                            <span
                                                class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ $review->rating }}/10</span>
                                        </div>
                                    @endif
                                    ...
                                    @if($review->updated_at != $review->created_at)
                                        <span class="text-sm text-gray-400"><i class="fa-solid fa-pen"></i> Редаговано
                                            {{ $review->updated_at->format('d.m.Y H:i') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
