                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @if(auth()->check() && $review->user_id == auth()->id())
                            <div class="flex items-center gap-2">
                                <button onclick="editComment({{ $review->id }})" class="flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-blue-500" title="Редагувати рецензію">
