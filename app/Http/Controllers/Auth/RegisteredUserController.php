...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'email.string' => 'Електронна пошта повинна бути текстом.',
            'email.email' => 'Електронна пошта повинна бути валідною адресою.',
            'email.max' => 'Електронна пошта не може перевищувати 255 символів.',
            ...
            'password.min' => 'Пароль повинен містити мінімум :min символів.',
            'password.letters' => 'Пароль повинен містити хоча б одну літеру.',
            'password.mixed' => 'Пароль повинен містити хоча б одну велику та одну малу літеру.',
            'password.numbers' => 'Пароль повинен містити хоча б одну цифру.',
            'password.symbols' => 'Пароль повинен містити хоча б один спеціальний символ.',
            'password.uncompromised' => 'Цей пароль був виявлений у витоку даних. Будь ласка, оберіть інший пароль.',
            'birth_date.date' => 'Дата народження повинна бути валідною датою.',
            'birth_date.before' => 'Дата народження повинна бути раніше сьогоднішньої дати.',
            'city.string' => 'Місто повинно бути текстом.',
            'city.max' => 'Назва міста не може перевищувати 255 символів.',
            'bio.string' => 'Біографія повинна бути текстом.',
            'bio.max' => 'Біографія не може перевищувати 1000 символів.',
            'favorite_genres.array' => 'Улюблені жанри повинні бути масивом.',
            'terms.required' => 'Ви повинні прийняти умови використання.',
